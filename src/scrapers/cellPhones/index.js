...
function scrapeStartPage(url) {
  return new Promise((resolve, reject) => {
    ...
    .set({
      ...
      'wifiSupport': '//dt[text()="Wi-Fi Support"]/following-sibling::dd',
      ...
      'mobileFreq': '//dt[text()="Mobile Frequencies"]/following-sibling::dd',
      'compatCarrier': '//dt[text()="Compatible Carrier & Service"]/following-sibling::dd',
      'dataTransfer': '//dt[text()="Data transfer"]/following-sibling::dd',
