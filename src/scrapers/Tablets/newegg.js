...
const settings = {
  ...
  datastoreKind: 'Tablets' // The kind for the new entity
};
...
function scrapeStartPage(url) {
  return new Promise((resolve, reject) => {
    ...
    .set({
      ...
      'Operating System': '//dt[text()="Operating System"]/following-sibling::dd',
      'wlan': '//dt[text()="WLAN"]/following-sibling::dd',
      'bluetooth': '//dt[text()="Bluetooth"]/following-sibling::dd',
      'cardReader': '//dt[text()="Card Reader"]/following-sibling::dd',
      'audioPorts': '//dt[text()="Audio Ports"]/following-sibling::dd',
      'otherFeatures': '//dt[text()="Other Features"]/following-sibling::dd',
    ...
    .then(function(context, data, next) {
      ...
      if (typeof data.hdmi !== 'undefined') {
        data.hdmi = data.hdmi.split(/<br>|,/g);
      }
      if (typeof data.audioPorts !== 'undefined') {
        data.audioPorts = data.audioPorts.split(/<br>|,/g);
      }
      if (typeof data.otherFeatures !== 'undefined') {
        data.otherFeatures = data.otherFeatures.split(/<br>|,/g);
      }
...
for (var i = 0; i < 12; i++) {
  let urlString = "www.newegg.com/Product/ProductList.aspx?Submit=ENE&N=100171661%204814%201100858365&IsNodeId=1&bop=And&Page=" + i + "&PageSize=96";
