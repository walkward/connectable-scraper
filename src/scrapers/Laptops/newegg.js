  ...
  return new Promise((resolve, reject) => {
    ...
    osmosis.get(url)
      ...
      // Check if product.model was found, we don't want this object otherwise.
        ...
        laptop.wlan =         typeof product.wlan !== 'undefined' ? _.chain(product.wlan.match(/802\.11[\s]?([acbgn/])*/gi)).toLower().replace(' ', '').split(',').compact().value() : null
        laptop.acAdapter =    typeof product.acAdapter !== 'undefined' ? product.acAdapter : null
        ...
        laptop.rj45 =         typeof product.lan !== 'undefined' && /10\/100|Ethernet/gi.test(product.lan) ? true : null
