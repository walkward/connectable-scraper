...
const settings = {
  ...
  datastoreKind: 'DockingStations'  // The kind for the new entity
};
...
function scrapeStartPage(url) {
  return new Promise((resolve, reject) => {
    ...
    .set({
      ...
      'compatibility': 'fieldset> dl > dt:contains("Compatibility") + dd:html',
      'portsSpec': 'fieldset> dl > dt:contains("Ports Spec") + dd:html',
    ...
    .then(function(context, data, next) {
      ...
      if (typeof data.portsSpec !== 'undefined') {
        data.portsSpec = data.portsSpec.split(/<br>|,/g);
      }
